...
//criar gerente
const manager1: IManager = new Manager('Lolinho Legal', 1);
const manager2: IManager = new Manager('Lolinho Chato', 2);
const manager3: IManager = new Manager('Lolinho Calmo', 3);
// Criar cliente
const cliente1: IClient = new Client('João Silva', 1, 'Rua A, 123', '(11) 1234-5678', manager1);
const cliente2: IClient = new Client('João Melo', 1, 'Rua b, 213', '(11) 1234-5988', manager3);
const cliente3: IClient = new Client('João Severion', 1, 'Rua c, 333', '(11) 1999-5678', manager2);
